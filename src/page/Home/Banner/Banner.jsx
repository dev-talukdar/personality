        ...
        <div>
            <div className="z-10">
                <div className="w-full bg-[#4298B4] py-10">
                    <h1 className="text-5xl text-center font-bold text-white">“What Is Your EATS SCORE  ?”</h1>
                    <p className='text-center text-white font-bold text-3xl mt-3'>Emotional Appetite Tendency Score</p>
                    <p className="text-white   lg:w-1/2 px-3 text-justify mt-5 mx-auto text-xl lg:text-center">The EATS SCORE<sup><span className='text-xs '>&copy;</span></sup> was developed in 2023 by author, life coach, and professional chef Molly Zemek as part of her book - <Link to="https://www.mollyzemek.com/book"><span className='underline text-yellow-100'>Decoding Your Emotional Appetite: A Food Lover’s Guide to Weight Loss</span></Link>. In one section of the book, Molly identifies 4 attributes that people tend to have that can drive their emotional eating: <span className='font-bold'> Security</span>, <span className='font-bold'>Escape</span>, <span className='font-bold'>Connection</span>, and <span className='font-bold'>Pleasure</span>.</p>
                    <p className='text-white lg:w-1/2 px-3 text-justify mt-5 mx-auto text-xl lg:text-center'>Please take the short 16 question quiz to provide  insight into where your tendencies  might lie. There are no right or wrong answers. Following the quiz, Molly will provide you with further understanding of your tendency along with additional tips for mindful eating.</p>
