...
const FreeTest = () => {
  const resultUrl = "https://eatscore.website/free-test";
  const subject = encodeURIComponent(
    "Decode Your Emotional Appetite…my present EATS score is…"
  );
  ...
  const Result = ({ indices }) => {
    const result = indices.reduce(
      (acc, index) => acc + parseInt(totalData[index].Score),
      0
    );
  ...
  return (
    <section>
        ...
        <div className="w-full">
          <div className="bg-[#33A474] py-14 md:relative">
            <h1 className="text-4xl font-bold text-white text-center ">
              What Is Your EATS Score ?
            </h1>
            <p className="text-white text-center mt-4 text-lg font-semibold">
              Emotional Appetite Tendency Score (EATS)
            </p>
          </div>
          <div className="custom-shape-divider-bottom-1699756183 ">
            ...
            >
              <path
                ...
                className="shape-fill fill-[#33A474]"
              ></path>
            </svg>
          </div>
        </div>
      ...
      <div className="mt-10">
        <form onSubmit={handleSubmit(onSubmit)} action="">
          {questions.map((question, index) => (
            <div key={index} className="my-16">
              ...
              <input
                {...register(`questionsName${question.id}`)}
              ...
              />
              <div
                onClick={() => QuestionHandler(index, question)}
                className={`${
                  index == indexNumber + 1 ? "static" : "opacity-30 "
                } `}
                id={`question-${index}`}
              >
                <div className="flex justify-center items-center gap-4 md:gap-10 mt-10 px-2">
                  <input
                    ...
                    className="radio h-16 w-16 border-2 hidden "
                  />
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <input
                      ...
                      defaultValue={0}
                      name={`question${question.id}`}
                      className="radio radio-success h-14 w-14 md:h-20  md:w-20 border-2 border-[#33a474]"
                    />
                    <label
                      htmlFor={`question${question.id}`}
                      className="text-xs md:text-sm font-bold text-[#33a474]"
                    >
                      NEVER
                    </label>
                  </div>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <input
                      ...
                      defaultValue={1}
                      name={`question${question.id}`}
                      className="radio radio-success w-12 h-12 md:h-14 md:w-14 border-2 border-[#33a474] "
                    />
                    <label
                      htmlFor={`question${question.id}`}
                      className="text-xs md:text-sm font-bold text-[#33a474]"
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <input
                      ...
                      defaultValue={2}
                      name={`question${question.id}`}
                      className="radio radio-[#88619A] w-8 h-8 md:h-10 md:w-10 radio-success  border-2 border-[#33a474]"
                    />
                    <label
                      htmlFor={`question${question.id}`}
                      className="text-xs md:text-sm font-bold text-[#33a474]"
        ...
        {table ? (
          <div
            className={`w-full lg:w-[70%] mx-auto items-center flex flex-col gap-5 my-14`}
          >
            <p className="text-lg font-semibold">
              The larger your number is in a certain category, the higher your
              Emotional Appetite Tendency Score (EATS) is in that area. With
              intentional effort and understanding your thought patterns, you
              can decode your emotional appetite, and change your relationship
              with food. As you progress in better knowing yourself, your
              personal needs, and how to care for yourself outside of eating,
              you might enjoy retaking this quiz to see how your answers change.
            </p>
            ...
            <div className="flex flex-col gap-11 my-8">
              <div className="flex flex-col md:flex-row gap-12">
                <div className="flex items-center gap-10 w-full">
                  ...
                  <p className="flex flex-col items-center text-3xl font-bold text-[#88619A]">
                    {" "}
                    Connection <Result indices={result01Indices} />
                  </p>
                </div>

                <div className="w-full">
                  <p className="text-lg font-bold">
                    Core Belief: I might stand out if I don’t join in.
                  </p>
                  <p className="text-lg font-bold">
                    Key Mindset Shift: I can control my own happiness.
                  </p>
                  <p className="text-lg font-bold">
                    Key Emotional Shift: From Obligated to Committed
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-12">
                <div className="flex items-center gap-10 w-full">
                  ...
                  <p className="flex flex-col items-center text-3xl font-bold text-[#88619A] whitespace-nowrap">
                    Escape <Result indices={result02Indices} />
                  </p>
                </div>

                <div className="w-full">
                  <p className="text-lg font-bold">
                    Core Belief: I deserve a treat.
                  </p>
                  <p className="text-lg font-bold">
                    Key Mindset Shift: I want to make time for myself to
                    decompress without food.
                  </p>
                  <p className="text-lg font-bold">
                    Key Emotional Shift: From Overwhelmed to Curious
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-12">
                <div className="flex items-center gap-10 w-full">
                  ...
                  <p className="flex flex-col items-center text-3xl font-bold text-[#88619A]">
                    Pleasure <Result indices={result03Indices} />
                  </p>
                </div>

                <div className="w-full">
                  <p className="text-lg font-bold">
                    Core Belief: More is better.
                  </p>
                  <p className="text-lg font-bold">
                    Key Mindset Shift: This is more than enough to be fully
                    satisfied.
                  </p>
                  <p className="text-lg font-bold">
                    Key Emotional Shift: From Dismissive to Satisfied
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-12">
                <div className="flex items-center gap-10 w-full">
                  ...
                  <p className="flex flex-col items-center text-3xl font-bold text-[#88619A]">
                    Security <Result indices={result04Indices} />
                  </p>
                </div>

                <div className="w-full">
                  <p className="text-lg font-bold">
                    Core Belief: Food will make me safe.
                  </p>
                  <p className="text-lg font-bold">
                    Key Mindset Shift: I can support myself.
                  </p>
                  <p className="text-lg font-bold">
                    Key Emotional Shift: From Entitled to Compassionate
                  </p>
                </div>
              </div>
            </div>
      ...
      {table ? (
        <div
          className={`w-full lg:w-[70%] mx-auto items-center flex flex-col gap-5 my-14 text-[#000]`}
        >
          <p>
            <span className="text-xl font-semibold">
              More information and tips available via Molly’s{" "}
              <a
                href="https://podcasts.apple.com/us/podcast/weight-loss-for-food-lovers/id1500464977"
                target="_blank"
                className="underline text-[#88619A]"
              >
                Weight Loss for Food-Lovers podcast
              </a>{" "}
              and in her book{" "}
              <a
                href="https://www.mollyzemek.com/book"
                target="_blank"
                className="underline text-[#88619A]"
              >
                Decoding Your Emotional Appetite: A Food-Lover’s Guide to Weight
                Loss.
              </a>
            </span>
          </p>
          ...
          <div className="inline-flex items-center gap-4">
            Share your EATS score:{" "}
            <span
              className="cursor-pointer text-[#1877f2] border px-3 py-3 rounded-full border-[#1877f2] hover:bg-[#1877f2] hover:text-white transition-all duration-500"
              onClick={() =>
                window.open(
            ...
            <span
              className="cursor-pointer text-[#000] border px-3 py-3 rounded-full border-[#356aaf] hover:bg-[#000] hover:text-white transition-all duration-500"
              onClick={() =>
                window.open(
                  `https://twitter.com/intent/tweet?text=Check%20out%20my%20result!&url=${encodeURIComponent(
                    resultUrl
                  )}`,
                  "_blank"
                )
            ...
            <span
              className="cursor-pointer text-[#c71610] border px-3 py-3 rounded-full border-[#c71610] hover:bg-[#c71610] hover:text-[#ffffff] transition-all duration-500"
              onClick={() =>
                window.open(
                  `https://www.instagram.com/create/story=${encodeURIComponent(
                    resultUrl
                  )}`,
                  "_blank"
                )
      ...
      <div className="modal">
        <div className="modal-box text-center">
          ...
          <p className="py-3 text-lg font-medium">
            Enter your e-mail address to get a copy of your results and save
            them for access at a later date.
          </p>
          ...
          <div className="py-4 relative w-4/5 mx-auto">
            <input
              ...
              className="px-12  py-4 border outline-none w-full focus:border-[#87609a] rounded-md placeholder:font-semibold"
            />
            <span className="absolute left-4 top-[42%]">
              <HiOutlineMail className="h-5 w-5 text-[#87609a]" />
            </span>
          </div>
          ...
          <div className="w-4/5 mx-auto">
            <button
              onClick={dataSubmit}
              className="bg-[#87609a] py-4 cursor-pointer text-center flex items-center justify-center rounded-l-full rounded-r-full font-semibold text-white w-full"
            >
              Send Result
            </button>
          </div>
          ...
          <div className="my-3">
            <p className="text-xs font-medium">
              We’ll never sell or inappropriately share your personal data. See
              our{" "}
              <Link to="" className="text-[#4298b4] hover:underline">
                Privacy Policy
              </Link>{" "}
              for more info. By continuing, you agree to our{" "}
              <Link to="/" className="text-[#4298b4] hover:underline">
                Terms & Conditions.
              </Link>
            </p>
      ...
      <div className="modal">
        <div className="modal-box">
          <div className="text-left flex gap-3">
            <div>
              ...
              <p className="py-3 text-lg">
                Let someone else glimpse into your personality by sharing your
                profile link.
              </p>
            </div>
            <div>
              <img
                src="https://www.16personalities.com/static/images/personality-types/avatars/isfj-defender-male.svg?v=3"
                alt="Img"
                className="w-52"
              />
            </div>
          ...
          <div className="flex items-center gap-6">
            <div>
              <p
                className="cursor-pointer text-[#1877f2] border px-5 py-5 rounded-full border-[#1877f2] hover:bg-[#1877f2] hover:text-white transition-all duration-500"
                onClick={() =>
                  window.open(
                    `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(
                      resultUrl
            ...
            <div>
              <p
                className="cursor-pointer text-[#4298b4] border px-5 py-5 rounded-full border-[#4298b4] hover:bg-[#4298b4] hover:text-white transition-all duration-500"
                onClick={() =>
                  window.open(
                    `https://twitter.com/intent/tweet?text=Check%20out%20my%20result!&url=${encodeURIComponent(
                      resultUrl
          ...
          <div className="my-4">
            ...
            <div className="my-2 w-full border px-5 py-2 rounded-r-full flex rounded-l-full items-center justify-between">
              ...
              <button
                className="border border-[#33A474] px-3 py-1 rounded-l-full rounded-r-full font-semibold text-[#33A474] hover:bg-[#33A474] hover:text-white transition-all duration-400"
